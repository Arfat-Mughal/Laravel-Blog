...
@section('description', 'Get in touch with us. We\'d love to hear from you! Whether you have questions, feedback, or just want to say hello.')
    ...
    <div class="container mx-auto px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="animate-on-scroll">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">{{ __('send_message') }}</h2>
                <p class="text-gray-600 dark:text-gray-300 mb-8">Fill out the form below and we'll get back to you as soon as possible.</p>
                
                <form action="{{ route('contact', app()->getLocale()) }}" method="POST" class="space-y-4 sm:space-y-6 p-4 sm:p-0" data-loading>
                    @csrf
                    <div class="space-y-2">
                        ...
                        <input
                            ...
                            name="name"
                            required
                            class="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 dark:border-slate-600 rounded-md sm:rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white dark:bg-slate-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                    ...
                    <div class="space-y-2">
                        ...
                        <input
                            ...
                            required
                            class="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 dark:border-slate-600 rounded-md sm:rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white dark:bg-slate-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                            placeholder="{{ __('message_subject') }}"
                        >
                    </div>
            ...
            <div class="space-y-6 sm:space-y-8 animate-on-scroll" style="animation-delay: 0.1s;">
                <div class="text-center lg:text-left">
                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-2 sm:mb-4">Contact Information</h3>
                    <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300">Have questions? We're here to help.</p>
                </div>
                ...
                <div class="space-y-4 sm:space-y-6">
                    <div class="flex items-start space-x-3 sm:space-x-4">
                        ...
                        <div>
                            <h4 class="text-sm sm:font-semibold text-gray-900 dark:text-white">Email</h4>
    ...
    <div class="container mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div class="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">How can I contribute to the blog?</h3>
                <p class="text-gray-600 dark:text-gray-300">We welcome guest posts! Please send us your ideas through the contact form, and we'll review them for publication.</p>
            </div>
            
            <div class="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">What topics do you cover?</h3>
                <p class="text-gray-600 dark:text-gray-300">We focus on web development, Laravel, modern technologies, tutorials, and insightful articles about software engineering.</p>
            </div>
            
            <div class="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">How long does it take to respond?</h3>
                <p class="text-gray-600 dark:text-gray-300">We aim to respond to all inquiries within 24-48 hours during business days. For urgent matters, please include that in your message.</p>
            </div>
            
            <div class="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">Do you offer advertising opportunities?</h3>
                <p class="text-gray-600 dark:text-gray-300">Yes, we have various advertising options available. Please contact us for our media kit and pricing information.</p>
            </div>
        </div>
    </div>
</section>
